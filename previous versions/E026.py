...
def main():
    ...
    out_detailed, oof_detailed, y_targets = get_prediction_from_model(
        is_detailed=True, to_subtract=True, model_name="lr", features_to_keep=get_best_features(model_type='lr')
    )
    ...
    out_xg, oof_xg, _ = get_prediction_from_model(
        is_detailed=True, to_subtract=False, model_name="xgb", features_to_keep=get_best_features(model_type="xgb")
    )
    ...
    out_xg_bin, oof_xg_bin, _ = get_prediction_from_model(
        is_detailed=True, to_subtract=False, model_name="xgb_bin", features_to_keep=get_best_features(model_type="xgb_bin")
    )
